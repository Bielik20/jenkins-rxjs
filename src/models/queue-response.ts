...
export function isQueueItemQuiet(
  response: QueueItem,
): response is QueueItemQuiet {
...
export function isQueueItemQueued(
  response: QueueItem,
): response is QueueItemQueued {
  return (
    typeof (response as QueueItemQueued).buildableStartMilliseconds === 'number'
  );
}
